...
| MERX Canadian open bids | https://www.merx.com/public/solicitations/open-bids | `c_msywoiwt25k5frwn95` | Completed crawl and same-ID healing attempts | 175 pre-heal; 201 rejected post-heal | listing IDs/URLs; detail fields attempted | Not canonical: full post-heal batch shifted fields, omitted title/deadline, and exposed contact text, so validation rejected it |
...
- `fixtures/recorded-live/canada-merx/run-live.json` — rejected incomplete 175-row crawl
